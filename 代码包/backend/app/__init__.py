...
def register_blueprints(app):
    ...
    from .controllers.user.delivery_controller import bp as user_delivery_bp
    from .controllers.user.mall_controller import bp as user_mall_bp
    from .controllers.device.auth_controller import bp as device_auth_bp
    from .controllers.device.delivery_controller import bp as device_delivery_bp
    ...
    app.register_blueprint(user_delivery_bp, url_prefix='/api/v1/user')
    app.register_blueprint(user_mall_bp, url_prefix='/api/v1/mall')
    app.register_blueprint(device_auth_bp, url_prefix='/api/v1/device')
    app.register_blueprint(device_delivery_bp, url_prefix='/api/v1/device')
